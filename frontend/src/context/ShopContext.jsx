...
const ShopContextProvider = (props) => {
    ...
    const addToCart= async (itemId,size)=>{
        ...
        if(token){
            try {
                ...
                let response = await axios.post(backendUrl + '/api/cart/add', {itemId,size}, {headers:{"Authorization":`Bearer ${token}`}});
    ...
    const value={
        ...
        setShowSearch, addToCart, CartItem, setCartItem, getCartCount, updateQuantity, 
