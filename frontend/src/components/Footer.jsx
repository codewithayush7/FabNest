    ...
    <div>
      <div className=" flex flex-col gap-10 sm:grid sm:grid-cols-[3fr_1fr_1fr] mt-25 py-15 text-gray-600">
        <div className="">
          ...
          <p className="mt-7 sm:w-lg">
            At FabNest, we believe shopping should feel like second nature—easy,
            joyful, and dependable. Whether you're chasing the latest trends or
            stocking up on your daily essentials, we're right here with you,
